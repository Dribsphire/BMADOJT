 ...
 * OJT Route - Instructor profile management with picture upload
 */
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if ($section): ?>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="<?= htmlspecialchars($section['section_code']) ?>" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Section Name</label>
                                            <input type="text" class="form-control" value="<?= htmlspecialchars($section['section_name']) ?>" readonly>
                                        </div>
                                    <?php else: ?>
